...
export class GamesService {
	...
	public async getGame(gameId: string): Promise<ApiResponse<Game<ApiMove>>> {
		...
		return this.http.get<ApiResponse<Game<ApiMove>>>(url, { headers })
			.toPromise()
			.catch(reason => reason.error);
	}

	public async getActiveGames(): Promise<ApiResponse<Game<ApiMove>[]>> {
